...
import EnrollmentForm from './components/academic/EnrrollementForm';
    ...
    <Router>
      ...
      <div className="container py-5">
        <Routes>
          ...
          {/* Listados - todos protegidos */}
          <Route 
            path="/list-alumnos" 
            element={<PrivateRoute element={<AlumnoList />} roleRequired="admin" />} 
          />
          <Route 
            path="/list-profesores" 
            element={<PrivateRoute element={<ProfesorList />} roleRequired="admin" />} 
          />
          <Route 
            path="/list-admins" 
            element={<PrivateRoute element={<AdminList />} roleRequired="admin" />} 
          />
          
          {/* Formularios - todos protegidos */}
          <Route 
            path="/create-user" 
            element={<PrivateRoute element={<UserForm />} roleRequired="admin" />} 
          />
          <Route 
            path="/list-carreras" 
            element={<PrivateRoute element={<CareerList />} roleRequired="admin" />} 
          />
          <Route 
            path="/list-courses" 
            element={<PrivateRoute element={<SubjectList />} roleRequired="admin" />} 
          />
          <Route 
            path="/list-periods" 
            element={<PrivateRoute element={<AcademicPeriodList />} roleRequired="admin" />} 
          />
          <Route 
            path="/create-career" 
            element={<PrivateRoute element={<CareerForm />} roleRequired="admin" />} 
          />
          <Route 
            path="/create-course" 
            element={<PrivateRoute element={<SubjectForm />} roleRequired="admin" />} 
          />
          <Route 
            path="/create-period" 
            element={<PrivateRoute element={<AcademicPeriodForm />} roleRequired="admin" />} 
          />
          <Route 
            path="/assign-professor" 
            element={<PrivateRoute element={<CourseForm />} roleRequired="admin" />} 
          />

          <Route 
            path="/assign-student" 
            element={<PrivateRoute element={<EnrollmentForm />} roleRequired="admin" />} 
          />
